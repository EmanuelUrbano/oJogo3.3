...
valoresRangeEpyCCH = {
    ...
    'carto': {
        ...
        'cch': [
            {'orange': range(360, 750), 'py': 100},
        ],
        'cev': [
            {'orange': range(80, 540), 'px': 410},
            
        ],
        'cdv': [
            
            {'orange': range(80, 540), 'px': 710},

        ],
        'cbh': [
           
            {'orange': range(360, 750), 'py': 480},
...
spritesCenario = {
    ...
    'carto':[pygame.transform.scale(pygame.image.load("images\quart-fer.png"),(800, 700)),pygame.transform.scale(pygame.image.load("images\quart-ab.png"), (800, 700))]
...
sprites = {
    ...
    'garoto': {
        'IdleDonw': pygame.image.load("images\character\garoto\idleDonw.png"),
        'IdleLeft': pygame.image.load("images\character\garoto\idleLeft.png"),
        'IdleUp': pygame.image.load("images\character\garoto\idleUp.png"),
        'IdleRigth': pygame.image.load("images\character\garoto\idleRight.png"),
        'animImgDonw': ["images\character\garoto\idleDonw.png", "images/character/garoto/animDonw1.png",
                        "images\character\garoto\idleDonw.png", "images/character/garoto/animDonw2.png"],
        'animImgLeft': ["images\character\garoto\idleLeft.png", "images/character/garoto/animLeft1.png",
                        "images\character\garoto\idleLeft.png", "images/character/garoto/animLeft2.png"],
        'animImgUP': ["images\character\garoto\idleUp.png", "images/character/garoto/animUp1.png",
                        "images\character\garoto\idleUp.png", "images/character/garoto/animUp2.png"],
        'animImgRight': ["images\character\garoto\idleRight.png", "images/character/garoto/animRight1.png",
                        "images\character\garoto\idleRight.png", "images/character/garoto/animRight2.png"],
    },
    'garota': {
        'IdleDonw': pygame.image.load("images\character\garota\idleDonw.png"),
        'IdleLeft': pygame.image.load("images\character\garota\idleLeft.png"),
        'IdleUp': pygame.image.load("images\character\garota\idleUp.png"),
        'IdleRigth': pygame.image.load("images\character\garota\idleRight.png"),
        'animImgDonw': ["images\character\garota\idleDonw.png", "images/character/garota/animDonw1.png",
                        "images\character\garota\idleDonw.png", "images/character/garota/animDonw2.png"],
        'animImgLeft': ["images\character\garota\idleLeft.png", "images/character/garota/animLeft1.png",
                        "images\character\garota\idleLeft.png", "images/character/garota/animLeft2.png"],
        'animImgUP': ["images\character\garota\idleUp.png", "images/character/garota/animUp1.png",
                        "images\character\garota\idleUp.png", "images/character/garota/animUp2.png"],
        'animImgRight': ["images\character\garota\idleRight.png", "images/character/garota/animRight1.png",
                        "images\character\garota\idleRight.png", "images/character/garota/animRight2.png"],
    },
    'npcs':[
        {
            'cara1':[
                pygame.image.load("images/npcs/cara2.png"),
                pygame.image.load("images/npcs/cara1.png"),
            ],
        },
        {
            'cara1':[
...
npcsPos = {
    'home': [
        {'x': 100, 'y': 140, 'sprite': sprites['npcs'][0]['cara1'][0]},
    ],
    'carto': [
...
def carto():
    ...
    vezes = 0
    character = sprites[spritePer]['IdleLeft']
    terrp = npcsPos['home'][0]['sprite']
    screen.blit(terrp, (100, 100))
    screen.blit(spritesCenario['carto'][0], (0, 0))
    ...
    while running:
        ...
        porta = abrirPorta( porPerto(pos_x, pos_y,'carto'))
        seraqestaporcima = sobreposicao(pos_x, pos_y, 'npcs', 'carto')
        ...
        mudarDeLugar(collisaDireitaVerticalBooleano('carto', pos_x, pos_y, valoresRangeEpyCCHMudardeLocal), 'game')
        desenharSobre(seraqestaporcima, character, terrp, pos_x, pos_y, 'carto', porta, 'carto', 250, -20)
...
def game():
    ...
    terrp = npcsPos['home'][0]['sprite']
    screen.blit(terrp, (100, 100))
    screen.blit(spritesCenario['home'][0], (0, 0))
    screen.blit(character, (pos_x, pos_y))
    running = True
    while running:
        ...
        desenharSobre(seraqestaporcima, character, terrp, pos_x, pos_y, 'home', 0, 'home', 0, 0)
        escreverFalas(pos_x, pos_y, euQueroConversar, vezes-1)
        mainClock.tick(10)
        print(pos_x, pos_y)
        pygame.display.flip()

def abrirPorta(perto):
    if perto == True:
        return 1
    else: 
        return 0
...
def desenharNpcs(bdxy):

    for i in range(len(npcsPos[bdxy])):
        screen.blit(npcsPos[bdxy][i]['sprite'],
                    (npcsPos[bdxy][i]['x'], npcsPos[bdxy][i]['y']))




def desenharSobre(sobreposicao, character, terrp, pos_x, pos_y, bd1, bd2, bdxyNpc, cenariox, cenarioy):
    if sobreposicao == True:
        screen.blit(spritesCenario[bd1][bd2], (cenariox, cenarioy))
        desenharNpcs(bdxyNpc)
        screen.blit(character, (pos_x, pos_y))
    else:
        screen.blit(spritesCenario[bd1][bd2], (cenariox, cenarioy))
        screen.blit(character, (pos_x, pos_y))
